                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-box ">
                                ...
                                <h2 class="text-uppercase bg-light p-2 mt-0 mb-3 text-center">Account Edit</h2>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" class="form-control" placeholder="Username" v-model="username" required>
                                ...
                                <!-- <div class="form-group mb-3">
                                    ...
                                    <input type="email" id="product-name" class="form-control" v-model="email" placeholder="example@mail.com" required>
                                ...
                                <!-- <div class="form-group mb-3">
                                    ...
                                    <input type="password" id="product-name" class="form-control" v-model="password" placeholder="Password" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" class="form-control" v-model="no_ktp" placeholder="No KTP" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="product-name" class="form-control" v-model="mobile_no" placeholder="Mobile Number" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input v-model="birth_date" type="datetime-local" id="product-name" class="form-control" placeholder="Birth of Date" step="1" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input v-model="birth_place" type="text" id="product-name" class="form-control" placeholder="Birth of Place" required>
...
export default {
    ...
    methods: {
        async load() {
            await axios.get('https://c2fc1e3ef947.ngrok.io/user/' + this.id).then((response) => {
        ...
        edit() {
            ...
            axios.put('https://c2fc1e3ef947.ngrok.io/user/' + this.id + '/action/update', formdata).then(res => {
